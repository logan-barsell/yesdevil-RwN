...
class DeleteMember extends Component {
  ...
  modalId = `modal${this.props.id}`;
  modalLabel = `label${this.props.id}`;
  ...
  render() {
    return (
      <>
        <div className="btn-sm btn-danger" type="button" data-bs-toggle="modal" data-bs-target={`#${this.modalId}`}>
        ...
        {/* <div className="modal fade" id={this.modalId} tabIndex="-1" aria-labelledby={this.modalLabel} aria-hidden="true">
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title" id={this.modalLabel}>DELETE MEMBER</h5>
              ...
              <div className="modal-body">
                Remove {this.props.name} as a member?
              </div>
              <div className="modal-footer">
                <div type="button" className="btn btn-dark" data-bs-dismiss="modal">Cancel</div>
                <div type="button" className="btn btn-danger">Delete</div>
              </div>
            </div>
          </div>
        </div> */}
